...
# ones.
extensions = [
    'sphinx.ext.autodoc',  # auto pull doc strings
    'sphinx.ext.doctest',
...
htmlhelp_basename = 'PyConTurbdoc'
...
latex_documents = [
    (master_doc, 'PyConTurb.tex', 'PyConTurb Documentation',
...
man_pages = [
    (master_doc, 'pyconturb', 'PyConTurb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyConTurb', 'PyConTurb Documentation',
     author, 'PyConTurb', 'One line description of project.',
     'Miscellaneous'),
]
