...
def test_con_iec_mn_std_dev():
    ...
    kwargs = {'u_ref': 10, 'turb_class': 'B', 'l_c': 340.2, 'z_ref': 70, 'T': 300, 'dt': 0.5,}
    coh_model = 'iec'
...
def test_collocated_turb():
    ...
    # given
    kwargs = {'u_ref': 10, 'turb_class': 'B', 'l_c': 340.2, 'z_ref': 75, 'T': 300, 'dt': .25}
    coh_model = 'iec'
    ...
    test = turb_df.u_p1 - turb_df.u_p1.mean()
    # then
